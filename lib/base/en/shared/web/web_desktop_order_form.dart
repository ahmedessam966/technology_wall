...
class WebDesktopOrderForm extends StatefulWidget {
  ...
  const WebDesktopOrderForm({super.key, required this.desktop});

  @override
  State<WebDesktopOrderForm> createState() => _WebDesktopOrderFormState();
}

late ProductModel desktop;
bool _isLoading = false;

class _WebDesktopOrderFormState extends State<WebDesktopOrderForm> {
  @override
  void initState() {
    super.initState();
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Text(
                    'Order Requisition For ${desktop.title}',
                                  ...
                                  content: Column(
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        ...
                                        validator: (value) =>
                                            InputValidationServices.validateName(name: value),
                                      ...
                                      TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          floatingLabelBehavior: FloatingLabelBehavior.always,
                                          label: Text(
                                            'Requested Quantity of ${desktop.title}',
                                            style: context.bodyLarge,
                                          ),
                                        ),
                                      ),
                                ...
                                Step(
                                  ...
                                  content: Column(
                                    ...
                                    children: [
                                      ...
                                      SelectableText(
                                          'Company/Client Contact Email:   ${_emailController.text}'),
                                      SelectableText(
                                          'Company/Client Contact Phone:   ${_phoneController.text}'),
                                      SelectableText(
                                          'Company/Client Req. Quantity:   ${_quantityController.text}'),
                                      SelectableText(
                                          'Company/Client Additional Notes:   ${_notesController.text}'),
                                      SizedBox(
                                        height: 5.h,
                                      ),
                                    ],

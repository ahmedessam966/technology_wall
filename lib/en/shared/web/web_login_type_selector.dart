...
class _WebLoginTypeSelectorState extends State<WebLoginTypeSelector> {
  ...
  Widget build(BuildContext context) {
    return BackdropFilter(
      ...
      child: Consumer<AuthControllers>(builder: (context, auth, _) {
              ...
              ? AlertDialog.adaptive(
                  ...
                  actions: [
                    ListTile(
                      ...
                      subtitle:
                          const Text('Select this if you are accessing your account on Technology Wall'),
                            ...
                            child: BaseRectButton(
                              ...
                              action: () async {
                                if (_loginFormKey.currentState!.validate()) {
                                  ...
                                  final res =
                                      await auth.userLogin(_emailController.text, _passController.text);

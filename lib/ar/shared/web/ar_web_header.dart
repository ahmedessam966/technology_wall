                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: Text('البرمجيات', style: context.displayLarge?.copyWith(color: Colors.white)),
                      ),
                      TextButton(
                        style: ButtonStyle(
                          overlayColor: MaterialStateProperty.resolveWith((states) {
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          app.pageTitle.endsWith('About') ? null : Navigator.pushNamed(context, '/ar/about');
                        },
                        child: Text('عن الشركة', style: context.displayLarge?.copyWith(color: Colors.white)),
                      ),
                      TextButton(
                        style: ButtonStyle(
                          overlayColor: MaterialStateProperty.resolveWith((states) {
                        ...
                        child: Text('تواصل معنا', style: context.displayLarge?.copyWith(color: Colors.white)),
                      ),
                    ],
                  ),
                ),

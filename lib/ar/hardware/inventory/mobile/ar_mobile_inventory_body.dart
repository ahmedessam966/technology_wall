...
import '../components/ar_mobile_inventory_category_card.dart';

class ARMobileInventoryBody extends StatelessWidget {
  final double sw;
  final double sh;
  final double ar;
  const ARMobileInventoryBody({super.key, required this.sw, required this.sh, required this.ar});
